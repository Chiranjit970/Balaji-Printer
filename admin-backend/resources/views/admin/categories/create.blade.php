    ...
    <form action="{{ route('admin.categories.store') }}" method="POST">
        ...
        <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Enter category name" required
                ...
                <div class="mt-2 text-xs text-slate-400 font-medium">
                    URL Slug: <span id="slug-preview" class="font-mono text-slate-500">n/a</span>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" min="0" name="display_order" id="display_order" value="{{ old('display_order', '0') }}" placeholder="0"
