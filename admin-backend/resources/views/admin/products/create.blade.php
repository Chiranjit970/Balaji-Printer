...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-2">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Add Product</h1>
                <p class="text-sm text-slate-500 mt-1">Create a new item in your catalog.</p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-5">
                ...
                <div>
                    ...
                    <div class="mt-1.5 text-xs text-slate-400">
                        Slug slug-url: <span id="slug-preview" class="font-semibold text-slate-500">n/a</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5" placeholder="Enter product description..."
                              class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:border-blue-600 @error('description') border-red-300 bg-red-50/20 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" name="price" id="price" value="{{ old('price') }}" placeholder="0.00"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm font-semibold">₹</span>
                            <input type="number" step="0.01" min="0" name="original_price" id="original_price" value="{{ old('original_price') }}" placeholder="0.00 (optional)"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" min="0" name="stock_quantity" id="stock_quantity" value="{{ old('stock_quantity', '0') }}" placeholder="0"
                    ...
                    <div>
                        ...
                        <input type="text" name="sku" id="sku" value="{{ old('sku') }}" placeholder="Optional product code"
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
                ...
                @include('admin.components.image-upload-grid')
                ...
                <div class="text-xs text-slate-500 bg-slate-50 border border-slate-100 rounded-lg p-3 leading-relaxed space-y-1">
                    ...
                    <p>• First selected image will serve as primary catalog thumbnail</p>
                </div>
            </div>
